# Данные для языка `mdf` от вендора Ali Kuzhuget
...
## stats/
Один файл mdf_population.csv со столбцами:
- year
...
- mdf_key_default.json

## frequencies/
mdf_monocorpus_freq.csv — частотности символов.

## mapping/
mdf_key_mapping.json — маппинг расширенных букв на русские клавиши.
